...
const SideNav = ({ isActive }) => {
    return (
        <div className="col-start-1 h-screen bg-white border-r border-gray-300 flex flex-col">
            ...
            <Link href="/client/ratings" passHref>
                <a 
                    className={ isActive === 'ratings' ? clientStyles.sideNavItemActive : clientStyles.sideNavItem }
                >
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        className={ clientStyles.sideNavIcon } 
                    ...
                    <p className="font-mont font-bold text-sm">Event Rating</p>
                </a>
            </Link>
        </div>
    )
