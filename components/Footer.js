const Footer = () => {
    ...
    return (
        <div className="w-full h-14 bg-true-100 border-t border-gray-200 flex justify-center items-center gap-x-1">
            <svg 
                className="w-6 h-6"
            ...
            <p className="text-sm border-gray-300 text-gray-600 font-bold">Copyright ACE { currYear } <span className="border-l border-gray-600 pl-1">All Rights Reserved</span></p>
        </div>
    )
}
