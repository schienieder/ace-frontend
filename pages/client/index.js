                        ...
                        <div className="flex flex-col gap-y-5">
                            ...
                            <div className="cardContainer">
                                <div className="cardHeader bg-white border-b border-gray-200">
                                    <h4 className="font-bold text-teal-800">Available Dates</h4>
                                </div>
                            ...
                            <div className="flex gap-x-5">
                                ...
                                <div className="w-2/5">
                                    <div className="cardContainer">
                                        <div className="cardHeader bg-white border-b border-gray-200">
                                            <h4 className="font-bold text-teal-800">Client Profile</h4>
                                        </div>
                                        <div className="cardBody">
                                ...
                                <div className="w-3/5">
                                    <div className="cardContainer">
                                        <div className="cardHeader bg-white border-b border-gray-200">
                                            <h4 className="font-bold text-teal-800">Event Activities</h4>
                                        </div>
                                        <div className="cardBody">
