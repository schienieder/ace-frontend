...
const seatingStyleArr = [
    { name : 'Theatre Style' },
    { name : 'Classroom Style' },
    { name : 'Banquet Style (Long Table)' },
    { name : 'Reception (Casual Table)' },
]
...
export default function add_booking() {
    ...
    const [venueType, setVenueType] = useState(venueTypeArr[0])
    const [seatingStyle, setSeatingStyle] = useState(seatingStyleArr[0])
                    ...
                    <div className="p-8 flex flex-col items-center gap-y-5 min-h-screen">
                        ...
                        <div className="card w-client-profile-form-container">
                            ...
                            >
                                ...
                                {/* venue type radio group field */}
                                <div className="w-full  px-2">
                                    <RadioGroup value={venueType} onChange={setVenueType} className="flex flex-col gap-y-1">
                                        <RadioGroup.Label className="inputFieldLabel">Type of Venue</RadioGroup.Label>
                                        <div className="grid grid-cols-2 grid-rows-3 gap-y-3 gap-x-5">
                                            {venueTypeArr.map((venue) => (
                                            <RadioGroup.Option
                                                key={venue.name}
                                                value={venue}
                                ...
                                {/* guests total & seating style fields */}
                                <div className="flex gap-x-5">
                                    <div className="flex flex-col gap-y-1">
                                    ...
                                    <div className="flex flex-col gap-y-1">
                                        <label htmlFor="booking_seating_style" className="inputFieldLabel">Seating Style</label>
                                        <Listbox as="div" className="w-63" value={seatingStyle} onChange={setSeatingStyle}>
                                            <div className="relative">
                                            <Listbox.Button className="relative text-left text-sm w-full px-3 py-1 bg-gray-200 text-gray-500 focus-within:text-teal-700 border-gray-200 focus:outline-none focus-within:border-teal-700 focus-within:ring-1 focus-within:ring-teal-700 rounded-sm">
                                                <span className="block truncate text-gray-500">{seatingStyle.name}</span>
                                                <span className="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="inputIcon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4" />
                                                </svg>
                                            ...
                                            <Transition
                                                ...
                                                leaveTo="opacity-0"
                                            >
                                                <Listbox.Options className="absolute z-20 w-full py-1 mt-1 overflow-auto text-sm bg-white rounded-md shadow-lg max-h-60 focus:outline-none sm:text-xs border border-gray-300">
                                                {seatingStyleArr.map((seating, seatingIdx) => (
                                                    <Listbox.Option
                                                    key={seatingIdx}
                                                    className={({ active }) =>
                                                        `${active ? 'text-gray-700 bg-gray-100' : 'text-gray-700'}
                                                    ...
                                                    {({ selected, active }) => (
                                                        ...
                                                        <span
                                                            className={`${
                                                            seatingStyle ? 'font-medium' : 'font-normal'
                                                            } block truncate`}
                                                        >
                                                            {seating.name}
                                                        </span>
                                ...
                                {/* time sched & desired date fields */}
                                <div className="flex gap-x-5">
                                    <div className="flex flex-col gap-y-1">
