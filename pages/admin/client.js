                        ...
                        <div className="self-start flex items-center gap-x-2">
                            ...
                            <div className="flex gap-x-2">
                                <Link href="/admin/clients">
                                    <h4 className="text-base md:text-xl font-bold dark:text-gray-300 cursor-pointer hover:underline">Client List</h4>
                                </Link>
                                <h4 className="text-base md:text-xl font-bold dark:text-gray-300 cursor-pointer hover:underline">\</h4>
                                <h4 className="text-base md:text-xl font-bold dark:text-gray-300">{ clientProfile.first_name+' '+clientProfile.last_name }</h4>
                            </div>
                        </div>
                        <div className="w-full lg:w-2/5 h-persona bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-700 rounded-xl flex flex-col items-center gap-y-5 py-10 px-5">
                            {
                            ...
                            <h4 className='text-xl font-bold -mb-3 text-center dark:text-gray-300'>{ clientProfile.first_name+" "+clientProfile.last_name }</h4>
                                <div className='flex items-center gap-x-2'>
                                    ...
                                    <p className='text-sm dark:text-gray-300'>{ clientProfile.mobile_number }</p>
                                </div>
                                <div className='flex items-center gap-x-2'>
                                    <svg 
                                        xmlns="http://www.w3.org/2000/svg" 
                                    ...
                                    <p className='text-sm dark:text-gray-300'>{ clientProfile.email }</p>
                                </div>
                                <div className='flex items-center gap-x-2'>
                                    {
                                        clientProfile.sex === 1 &&
                                        <>
                                            ...
                                            <p className='text-sm dark:text-gray-300'>Female</p>
                                        </>
                                    }
                                    {
                                        clientProfile.sex === 0 &&
                                        <>
                                            ...
                                            <p className='text-sm dark:text-gray-300'>Male</p>
                                        </>
                                    }
                                </div>
                                <div className='flex items-center gap-x-2'>
                                    ...
                                    <p className='text-sm dark:text-gray-300'>{ clientProfile.birthdate ? displayAge(clientProfile.birthdate) + ' years old' : 'N/A' }</p>
                                </div>
                                <div className='flex items-center gap-x-2'>
                                    <svg 
                                        xmlns="http://www.w3.org/2000/svg" 
                                    ...
                                    <p className='text-sm dark:text-gray-300'>{ clientProfile.street_address && clientProfile.city ? clientProfile.street_address + ', ' + clientProfile.city : 'N/A' }</p>
                                </div>
                            </div>
                        </div>
                    </div>
